  ...
  <div class="full-width">
    <q-list class="row">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pb-md">
        ...
        <q-scroll-area v-if="sltBegin.length" :style="sltBegin.length === 1 ? 'height: 210px;' : sltBegin.length === 2 ? 'height: 390px;' : 'height: 410px;'">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pb-md">
        ...
        <q-scroll-area v-if="sltProgress.length" :style="sltProgress.length === 1 ? 'height: 210px;' : sltProgress.length === 2 ? 'height: 390px;' : 'height: 410px;'">
          <q-list class="q-px-md q-py-sm">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pb-md">
        ...
        <q-scroll-area v-if="sltCheckout.length" :style="sltCheckout.length === 1 ? 'height: 210px;' : sltCheckout.length === 2 ? 'height: 390px;' : 'height: 410px;'">
          <q-list class="q-px-md q-py-sm">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pb-md">
        ...
        <q-scroll-area v-if="sltConfirm.length" :style="sltConfirm.length === 1 ? 'height: 210px;' : sltConfirm.length === 2 ? 'height: 390px;' : 'height: 410px;'">
          <q-list class="q-px-md q-py-sm">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 q-pb-md">
        ...
        <q-scroll-area v-if="sltEnd.length" :style="sltEnd.length === 1 ? 'height: 210px;' : sltEnd.length === 2 ? 'height: 390px;' : 'height: 410px;'">
          <q-list class="q-px-md q-py-sm">
